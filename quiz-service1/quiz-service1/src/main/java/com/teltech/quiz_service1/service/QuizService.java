package com.teltech.quiz_service1.service;
...
import com.teltech.quiz_service1.model.Question;
import com.teltech.quiz_service1.model.QuestionWrapper;
import com.teltech.quiz_service1.model.Quiz;
import com.teltech.quiz_service1.model.Response;
import com.teltech.quiz_service1.repository.QuizRepo;
...
public class QuizService {
    ...
    public List<QuestionWrapper> getQuestionsById(List<Integer> questionIds) {
        String apiUrl = "http://localhost:8080/getQuestions";
    ...
    public Integer getScore(List<Response> responses) {
        Integer score = 0;
        String apiUrl = "http://localhost:8080/getscore";
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ObjectMapper objectMapper = new ObjectMapper();
